"""Run a graph-backed 2WikiMultiHopQA subset ingestion smoke test."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate 2WikiMultiHopQA local graph build and GraphStore loading.")
    ...
    print("=== 2WikiMultiHopQA Graph Subset Dry Run ===")
