"""Run a minimal 2WikiMultiHopQA ingestion and TaskSample conversion dry-run."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Validate 2WikiMultiHopQA subset ingestion.")
    ...
    print("=== 2WikiMultiHopQA Subset Dry Run ===")
    ...
    for index, task in enumerate(tasks):
        print(
            ...
            f"evidences={len(task.metadata.get('evidences', []))}"
        )
