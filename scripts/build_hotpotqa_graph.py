"""Build benchmark local graphs from local HotpotQA files."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build local graph specs from HotpotQA examples.")
