"""Inspect local HotpotQA records and their TaskSample conversion."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Inspect local HotpotQA examples.")
    ...
    for index, example in enumerate(examples):
        ...
        print(f"=== HotpotQA Example {index} ===")
