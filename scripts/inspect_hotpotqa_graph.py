"""Inspect one HotpotQA local graph built from benchmark context."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Inspect a HotpotQA benchmark local graph.")
    ...
    example = load_hotpotqa(args.path, indices=[args.index], split=args.split)[0]
